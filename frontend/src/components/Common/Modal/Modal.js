...
function ModalBasic({ props, visible, setVisible }) {
				...
				<div className="flex justify-center">
					<form action='' onSubmit={submitHandler}>
						...
						<div className="mb-5 mx-3">
							...
							<textarea className="block w-full border mt-2 text-15 border-solid border-black py-3 px-4 rounded-md focus:outline-none focus:border-red-1 focus:placeholder-transparent" id="description_field" rows="6" value={description} onChange={(e) => setDescription(e.target.value)}></textarea>
						</div>
						<div>
